...
API_URL = "https://fastapi-insurance-predictor.onrender.com/predict"
...
"Occupation",
['government_job', 'private_job', 'business_owner', 'engineer',
...
if st.button("Predict Premium Category"):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            st.info(f"Confidence Score: {round(result['confidence'] * 100, 2)}%")
